<script type="text/javascript">
  {
    RED.nodes.registerType("NLP-send-message", {
      category: "messageAPI",
      color: "#99ccff",
      defaults: {
        ...
        intentId: {
          value: "",
          required: true,
          validate: RED.validators.typedInput("intentIdType"),
        },
        intentIdType: { value: "msg" },
        conversationId: {
          value: "",
          required: true,
          validate: RED.validators.typedInput("conversationIdType"),
        },
        conversationIdType: { value: "msg" },
        messageOption: { value: "" },
        name: { value: "" },
        payload: {
          value: "",
      ...
      label: function () {
        return this.name || "NLP-send-message";
      },
    ...
    function configureInputs() {
      ...
      $("#node-input-intentId").typedInput({
        default: "msg",
        types: ["msg"],
        typeField: $("#node-input-intentIdType"),
      });
      ...
      $("#node-input-conversationId").typedInput({
        default: "msg",
        types: ["msg"],
        typeField: $("#node-input-conversationIdType"),
      });
    }
...
<script type="text/html" data-template-name="NLP-send-message">
  <div id="node-config-template-tab-send-message">
    ...
    <div class="form-row">
      <label for="node-input-traceID">
        <i class="fa fa-tag"></i> traceID
      </label>
    ...
    <div class="form-row">
      <label for="node-input-intentId">
        <i class="fa fa-indent"></i> Intent
      </label>
      <input type="text" id="node-input-intentId" style="width: 70%" />
      <input type="hidden" id="node-input-intentIdType" />
    </div>

    <div class="form-row">
      <label for="node-input-conversationId">
        <i class="fa fa-comment"></i> Conversation ID
      </label>
      <input type="text" id="node-input-conversationId" style="width: 70%" />
      <input type="hidden" id="node-input-conversationIdType" />
    </div>
...
<script type="text/html" data-help-name="NLP-send-message">
  <p>Request to send messages via NLP</p>
</script>
